							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">\
                                ...
                                <div class="menu-item">
									<a class="menu-link active" href="{{ route('product.index') }}">
										...
										<span class="menu-title">Activity 1 - CRUD</span>
									</a>
								</div>
                                <div class="menu-item">
									<a class="menu-link active" href="{{ route('file.index') }}">
										<span class="menu-icon">
										...
										<span class="menu-title">Activity 2 - Uploading</span>
									</a>
								</div>
                            </div>
                        </div>
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                                    ...
                                                    <div class="menu-item">
														<a class="menu-link py-3" href="#">
															...
															<span class="menu-title">Another Action</span>
														</a>
													</div>
													<div class="menu-item">
                        ...
                        <div class="toolbar" id="kt_toolbar">
                            ...
                            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                                ...
                                <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                                    <!--begin::Title-->
                                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Laravel Activities
                                    <!--begin::Separator-->
                                    <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
                                    <!--end::Separator-->
                                    <!--begin::Description-->
                                    <small class="text-muted fs-7 fw-bold my-1 ms-1">Web Software Tools 2</small>
                                    <!--end::Description--></h1>
                                    <!--end::Title--> 
                                </div>
                            </div>
